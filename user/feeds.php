...
<body>
  ...
  <a href="addnewitem.php">
    <button class="bg-yellow-500 text-white px-4 py-2 rounded">+ Add Item</button>
  </a>
  ...
  <div class="border-b border-zinc-200">
    <nav class="flex space-x-4">
      ...
      <a href="#" class="py-2 px-4 text-black font-semibold" onclick="showContent('feedingProgram')">Feed Items</a>
